...
if(isset($_POST['submit'])){
  ...
  if(empty($errors)){
      ...
      $result = myQuery("INSERT INTO access_subject (subject,teacher,passmark,fullmark) VALUES ('$subject_name','$teacher','$pass_mark','$full_mark')");
...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">
            ...
            <p class="resett"><i class="fa fa-edit"></i>&nbsp;&nbsp;Subject - Jss One</p>
        </h3>
