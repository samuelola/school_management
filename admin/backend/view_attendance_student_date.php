...
<div class="row">
    <div class="col-lg-12">
      ...
      <div class="row">
           <b><p class="text-center">Date : <?php display_student_date() ?></p></b>
              ...
              <tbody>
               ...
               <?php 
                     ...
                     if(isset($_GET['view_attendance_student_date'])){
                        $sn = 0;
                        $attendance_date = $_GET['view_attendance_student_date'];

                        $sql = myQuery("SELECT * FROM access_student_js_1 INNER JOIN student_attendance ON access_student_js_1.id = student_attendance.id WHERE attend_date = '$attendance_date' ");
