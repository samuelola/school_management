<?php 
  ...
  if(isset($_GET['edit_subject_ss_three'])){
    ...
    $user_id = $_GET['edit_subject_ss_three'];
     
     $sql = myQuery("SELECT * FROM access_subject_ss_3 WHERE id = '$user_id'");
     ...
     if(isset($_POST['update'])){
       ...
       $resultme = myQuery("UPDATE access_subject_ss_3 SET subject = '$subject_name', teacher= '$teacher',passmark='$pass_mark',fullmark='$full_mark' WHERE id = '$user_id'");
 ...
 <div class="row">
     <div class="col-lg-12">
         <h3 class="page-header">
             ...
             <p class="resett"><i class="fa fa-edit"></i>&nbsp;&nbsp;Subject - sss - one</p>
         </h3>
