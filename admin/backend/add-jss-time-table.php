...
<div class="row">
    <div class="col-lg-12">
       ...
       <ul class="nav nav-tabs">
         <li class="modal-scrollbar-measures"><a href="index.php?jss-time-table">View Time-Table</a></li>
         <li class="active"><a href="index.php?add-jss-time-table">Add Time-Table</a></li>
         <li class="rolls"><a href="index.php?update-jss-time-table">Update Time-Table</a></li>
               ...
               <?php 
                    ...
                    if(isset($_POST['timeTableArray1'])){
                      ...
                      foreach ($_POST['timeTableArray1'] as $checkValue) {
                          ...
                          $subject1v = $_POST['subject1v'];
                          $subject1w = $_POST['subject1w'];
                          

                          
                           $sql = "INSERT INTO day1 (subject1a, subject1b, subject1c, subject1d, subject1e, subject1f, subject1g,subject1h,subject1i, subject1j, subject1k, subject1l, subject1m, subject1n, subject1o,subject1p,subject1q, subject1r, subject1s, subject1t, subject1u,subject1v, subject1w) VALUES ('$subject1a', '$subject1b', '$subject1c', '$subject1d', '$subject1e', '$subject1f', '$subject1g','$subject1h','$subject1i','$subject1j','$subject1k','$subject1l','$subject1m','$subject1n','$subject1o','$subject1p','$subject1q','$subject1r','$subject1s','$subject1t','$subject1u','$subject1v','$subject1w')";
                          
                            $get_info = "SELECT * FROM day1 WHERE id = 1";
                    ...
                    if(isset($_POST['timeTableArray2'])){
                      ...
                      foreach ($_POST['timeTableArray2'] as $checkValue) {
                          ...
                          $subject2v = $_POST['subject2v'];
                           ...
                           $sql = "INSERT INTO day2 (subject2a, subject2b, subject2c, subject2d, subject2e, subject2f, subject2g,subject2h,subject2i, subject2j, subject2k, subject2l, subject2m, subject2n, subject2o,subject2p,subject2q, subject2r, subject2s, subject2t, subject2u,subject2v) VALUES ('$subject2a', '$subject2b', '$subject2c', '$subject2d', '$subject2e', '$subject2f', '$subject2g','$subject2h','$subject2i','$subject2j','$subject2k','$subject2l','$subject2m','$subject2n','$subject2o','$subject2p','$subject2q','$subject2r','$subject2s','$subject2t','$subject2u','$subject2v')";
                    ...
                    if(isset($_POST['timeTableArray3'])){
                      ...
                      foreach ($_POST['timeTableArray3'] as $checkValue) {
                          ...
                          $subject3u = $_POST['subject3u'];
                           ...
                           $sql = "INSERT INTO day3 (subject3a, subject3b, subject3c, subject3d, subject3e, subject3f, subject3g,subject3h,subject3i, subject3j, subject3k, subject3l, subject3m, subject3n, subject3o,subject3p,subject3q, subject3r, subject3s, subject3t, subject3u) VALUES ('$subject3a', '$subject3b', '$subject3c', '$subject3d', '$subject3e', '$subject3f', '$subject3g','$subject3h','$subject3i','$subject3j','$subject3k','$subject3l','$subject3m','$subject3n','$subject3o','$subject3p','$subject3q','$subject3r','$subject3s','$subject3t','$subject3u')";
                          
                            $get_info = "SELECT * FROM day3 WHERE id = 3";
                    ...
                    if(isset($_POST['timeTableArray4'])){
                      ...
                      foreach ($_POST['timeTableArray4'] as $checkValue) {
                          ...
                          $subject4v = $_POST['subject4v'];

                          $subject4w = $_POST['subject4w'];
                          $subject4x = $_POST['subject4x'];
                          
                          
                          

                          
                           $sql = "INSERT INTO day4 (subject4a, subject4b, subject4c, subject4d, subject4e, subject4f, subject4g,subject4h,subject4i, subject4j, subject4k, subject4l, subject4m, subject4n, subject4o,subject4p,subject4q, subject4r, subject4s, subject4t, subject4u,subject4v,subject4w,subject4x) VALUES ('$subject4a', '$subject4b', '$subject4c', '$subject4d', '$subject4e', '$subject4f', '$subject4g','$subject4h','$subject4i','$subject4j','$subject4k','$subject4l','$subject4m','$subject4n','$subject4o','$subject4p','$subject4q','$subject4r','$subject4s','$subject4t','$subject4u','$subject4v','$subject4w','$subject4x')";
                          
                            $get_info = "SELECT * FROM day4 WHERE id = 4";
                    ...
                    if(isset($_POST['timeTableArray5'])){
                      ...
                      foreach ($_POST['timeTableArray5'] as $checkValue) {
                          ...
                          $subject5n = $_POST['subject5n'];
                           ...
                           $subject5o = $_POST['subject5o'];
                          
                          

                          
                           $sql = "INSERT INTO day5 (subject5a, subject5b, subject5c, subject5d, subject5e, subject5f, subject5g,subject5h,subject5i, subject5j, subject5k, subject5l, subject5m, subject5n,subject5o) VALUES ('$subject5a', '$subject5b', '$subject5c', '$subject5d', '$subject5e', '$subject5f', '$subject5g','$subject5h','$subject5i','$subject5j','$subject5k','$subject5l','$subject5m','$subject5n','$subject5o')";
                          
                            $get_info = "SELECT * FROM day5 WHERE id = 5";
                ...
                ?>
                                          ...
                                          <div class="row">
                                            ...
                                            <table class=" table table-responsive jss1 table-bordered">
                                               <thead>
                                                   <tr>
                                                     <th></th>
                                                     <th>Class</th>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td colspan="2">
                                                          <select name="subject1a" id="" >
                                                            ...
                                                            <option value="SOCIAL ST">SOCIAL ST</option>
                                                            ...
                                                            <option value="BUS ST">BUS ST</option>
                                  ...
                                  <!---------------------------------------------------------->
                                                 ...
                                                 <tr>
                                                    ...
                                                    <tr>
                                                         ...
                                                         <td></td>
                                                         <td colspan="3" rowspan="3">EXTRA CURRICULAR</td>
