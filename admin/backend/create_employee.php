...
if(isset($_POST['submit'])){
  ...
  $result = myQuery("INSERT INTO access_employee (name,email,password,phone,dob,join_date,gender,image,grade) VALUES ('$name','$email','$pass_hash','$phone','$dob','$join_date','$gender','$image','$grade')");

  

   confirm($result);

   set_message("Employee has been created!");
...
<div class="row">
    <div class="col-lg-12">
       ...
       <ul class="nav nav-tabs">
          <li class="active"><a href="#">Create Employee</a></li>
          <li class="rolls"><a href="index.php?view_employee">View Employee</a></li>
