<?php 
  ...
  if(isset($_GET['edit_subject_ss_one'])){
    ...
    $user_id = $_GET['edit_subject_ss_two'];
     
     $sql = myQuery("SELECT * FROM access_subject_ss_2 WHERE id = '$user_id'");
     ...
     if(isset($_POST['update'])){
       ...
       $resultme = myQuery("UPDATE access_subject_ss_2 SET subject = '$subject_name', teacher= '$teacher',passmark='$pass_mark',fullmark='$full_mark' WHERE id = '$user_id'");
