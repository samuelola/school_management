...
if(isset($_POST['submit'])){
  ...
  if(empty($errors)){
     ...
     $result = myQuery("INSERT INTO access_student_js_1 (name,email,password,parent,reg_no,dept,phone,dob,join_date,gender,address,class,section,photo) VALUES ('$name','$email','$pass_hash','$parent','$reg_no','$dept','$phone','$dob','$join_date','$gender','$address','$class','$section','$image')");
...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">
            ...
            <p class="resett"><i class="fa fa-edit"></i>&nbsp;&nbsp;Create Student JSS</p>
        </h3>
