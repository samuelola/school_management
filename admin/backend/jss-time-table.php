...
<div class="row">
    <div class="col-lg-12">
       ...
       <ul class="nav nav-tabs">
         <li class="active"><a href="index.php?jss-time-table">View Time-Table</a></li>
         <li class="rolls"><a href="index.php?add-jss-time-table">Add Time-Table</a></li>
       ...
       <div class="myboxxm">
            ...
            <h4 class="jsstable" style="text-align: center;">JSS TIMETABLE</h4>
                ...
                <table class=" table table-responsive jss1  table-bordered" id="jss1">
                   <thead>
                       <tr>
                         <th></th>
                         <th>Class</th>
              ...
              <?php 
                   ...
                   $row = mysqli_fetch_assoc($result);
                       ...
                       $subject1v = $row['subject1v'];
                       $subject1w = $row['subject1w'];
               ...
               ?>
                   ...
                   <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $subject1n ?></td>
                          <td><?php echo $subject1o ?></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td><?php echo $subject1r ?></td>
                          <td></td>
                          <td><?php echo $subject1s ?></td>
                          <td><?php echo $subject1t ?></td>
                          <td></td>
                          <td><?php echo $subject1u ?></td>
                          <td><?php echo $subject1v ?></td>
                          <td><?php echo $subject1w ?></td>
                        </tr>
                       ...
                       <?php 
                        ...
                        <tr>
                          ...
                          <td></td>
                          <td  colspan="2"><?php echo $subject2l ?></td>
                          <td></td>
                        ...
                        <tr>
                          ...
                          <td></td>
                          <td colspan="2"><?php echo $subject2s ?></td>
                          <td></td>
                          <td><?php echo $subject2t ?></td>
                          <td><?php echo $subject2u ?></td>
                        ...
                        <tr>
                          ...
                          <td>SHORT BREAK</td>
                          <td  colspan="2"><?php echo $subject3d ?></td>
                          <td>LUNCH BREAK</td>
                          <td><?php echo $subject3e ?></td>
                          <td><?php echo $subject3f ?></td>
                        ...
                        <tr>
                          ...
                          <td>J.S.2</td>
                          <td><?php echo $subject3h ?></td>
                          <td><?php echo $subject3i ?></td>
                          <td><?php echo $subject3j ?></td>
                          <td></td>
                          <td  colspan="2"><?php echo $subject3k ?></td>
                          <td></td>
                          <td><?php echo $subject3l ?></td>
                          <td><?php echo $subject3m ?></td>
                          <td><?php echo $subject3n ?></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td></td>
                          <td colspan="2"><?php echo $subject3r ?></td>
                          <td></td>
                          <td><?php echo $subject3s ?></td>
                          <td><?php echo $subject3t ?></td>
                          <td><?php echo $subject3u ?></td>
                        </tr>
      ...
      <!---------------------------------------------------------->
                     ...
                     <?php 
                          ...
                          $row = mysqli_fetch_assoc($result);
                              ...
                              $subject4v = $row['subject4v'];
                              $subject4w = $row['subject4w'];
                              $subject4x = $row['subject4x'];
                     ...
                     <tr>
                        ...
                        <tr>
                          ...
                          <td><?php echo $subject4r ?></td>
                          <td><?php echo $subject4s ?></td>
                          <td>SHORT BREAK</td>
                          <td><?php echo $subject4t ?></td>
                          <td><?php echo $subject4u ?></td>
                          <td>LUNCH BREAK</td>
                          <td><?php echo $subject4v ?></td>
                          <td><?php echo $subject4w ?></td>
                          <td><?php echo $subject4x ?></td>         
