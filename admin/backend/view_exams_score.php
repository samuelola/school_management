...
<div class="row">
    <div class="col-lg-12">
       ...
       <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="index.php?create_exam_score">Create Exam Score</a></li>
               ...
               <?php
                     ...
                     $sql = myQuery("SELECT * FROM access_student_js_1");
                         ...
                         <tr>
                           ...
                           <td><a href="index.php?view_subjects_score=<?php echo $id ?>" class="btn btn-xs btn-info">View Subjects score</a></td>
