...
$total_students =  $all_jss_students + $all_sss_students;
                                 ...
                                 function drawChart() {
                                   var data = google.visualization.arrayToDataTable([
                                     ...
                                     <?php 
                                       ...
                                       $element_text = ['All Teachers','All Students','All Employees'];
                                       $element_count = [$all_teachers,$total_students,$all_employee];
