...
if(isset($_POST['submit'])){
  ...
  if(empty($errors)){
      ...
      $result = myQuery("INSERT INTO access_subject_ss_3 (subject,teacher,passmark,fullmark) VALUES ('$subject_name','$teacher','$pass_mark','$full_mark')");
...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">
            ...
            <p class="resett"><i class="fa fa-edit"></i>&nbsp;&nbsp;Subject - Sss Three</p>
        </h3>

       <ul class="nav nav-tabs">
          <li class="active"><a href="#">Create Subject</a></li>
          <li class="rolls"><a href="index.php?view_subject_sss_three">View Subject</a></li>
