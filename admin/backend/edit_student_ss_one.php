...
if(isset($_GET['edit_student_ss_one'])){
  ...
  $user_id = $_GET['edit_student_ss_one'];
   
   $sql = myQuery("SELECT * FROM access_student_ss_1 WHERE id = '$user_id'");
   ...
   if(isset($_POST['update'])){
     ...
     if(empty($image)){
        ...
        $example2 = myQuery("SELECT * FROM access_student_ss_1 WHERE id = '$user_id'");
     ...
     $resultme = myQuery("UPDATE access_student_ss_1 SET name = '$name', email= '$email',password='$pass_hash',parent='$parent',reg_no='$reg_no',dept ='$dept',phone='$phone',dob='$dob',join_date='$join_date',gender='$gender',address = '$address', class = '$class',section='$section',photo='$image' WHERE id = '$user_id'");
                           ...
                           <select name="gender" id="">
                               ...
                               <?php
                                   ...
                                   if($gender == 'Male'){
                                      ...
                                      $sam = myQuery("SELECT * FROM access_student_ss_1");
                           ...
                           <select name="class" id="">
                               ...
                               <?php 
                                  ...
                                  if($class == 'sss one'){
                                     ...
                                     ?><option value="sss one">sss one</option><?php 
                                  }
                                  ...
                                  if($class == 'sss two'){
                                     ...
                                     ?><option value="sss two">sss two</option><?php 
                                  }
