...
if(isset($_POST['submit'])){
  ...
  if(empty($errors)){
      ...
      $result = myQuery("INSERT INTO access_subject_ss_1  (subject,teacher,passmark,fullmark) VALUES ('$subject_name','$teacher','$pass_mark','$full_mark')");
...
<div class="row">
    <div class="col-lg-12">
       ...
       <ul class="nav nav-tabs">
          ...
          <li class="rolls"><a href="index.php?view_subject_sss_one">View Subject</a></li>
