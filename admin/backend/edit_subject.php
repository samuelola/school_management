<?php 
  ...
  if(isset($_GET['edit_subject'])){
    ...
    $user_id = $_GET['edit_subject'];
     
     $sql = myQuery("SELECT * FROM access_subject WHERE id = '$user_id'");
     ...
     if(isset($_POST['update'])){
       ...
       $resultme = myQuery("UPDATE access_subject SET subject = '$subject_name', teacher= '$teacher',passmark='$pass_mark',fullmark='$full_mark' WHERE id = '$user_id'");
            ...
            <form action="" method="post" autocomplete="on" enctype="multipart/form-data">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="row ti">
                        ...
                        <div class="col-sm-8">
                            <input type="submit" class="btn btn-sm btn-info" name="update" value="Add Subject">
